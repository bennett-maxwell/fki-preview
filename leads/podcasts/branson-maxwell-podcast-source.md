<!-- v1.6 -->
NOTEBOOKLM SOURCE DOCUMENT — Personal AI Walkthrough for Business Owner
Your Business | Prepared by Franchise Ki | Generated 2026-05-27

================================================================================
SPEAKER INSTRUCTIONS — 3 HARD RULES (read this once, then begin)
================================================================================

RULE 1 (RED LINE): You are speaking DIRECTLY to BUSINESS OWNER. Use "you" and
"your business" in every paragraph. NEVER say "Business Owner" in the third person.
NEVER say "this business," "the owner," "they," or "their team." If you catch
yourself describing Business Owner from the outside, stop and restart the sentence
addressed to them.

RULE 2: Open the audio with EXACTLY these words: "Hi Business, welcome.
This walkthrough was built for you and Your Business, from what you told us."
Then proceed.
...
## SECTION 1 — Hi Business, this is your walkthrough

Hi Business — welcome. This is your AI walkthrough, built for you and
Your Business. Every number you're about to hear came from what you told us.

You operate in professional services, serving local and regional customers. You run Your Business at [Your Business website].
...
You told us your current tools are: standard business tools. We're going to wire your AI system
...
You told us your current AI use is early-stage. That's exactly where most professional services businesses are right now — and it's the right starting point.

The 3 AI tools you'll hear about in Section 4 were written specifically for you and
Your Business. Not adjusted from a template. Built from your answers, for how
your business actually works. Let's walk through what's possible.

---

## SECTION 2 — Your Current Tool Stack: Where Your Business Is Today
...
- **Standard professional services workflow tools**: Core operational tool in your current stack.
...
These aren't guesses. These are the gaps that show up consistently for professional services
...
In professional services, that window is measured in minutes — sometimes seconds. Every hour your
...
In professional services, this shows up as: proposal writing, status updates, follow-up emails,
...
## SECTION 4 — The 3 AI Tools Built Specifically for Your Business
...
[No custom prompt provided — describe key AI speed-to-lead opportunity for professional services]
...
[No custom prompt provided — describe key AI proposal or qualification opportunity for professional services]

Built around how Your Business actually works — not a generic industry template.

---

### AI Tool 3 — Follow-Up and Outreach Agent

[No custom prompt provided — describe key AI follow-up or outreach opportunity for professional services]
...
## SECTION 5 — What Your Customers Already Say About Your Business

Your reputation in local and regional customers is an asset. Customer feedback for professional services businesses
at your stage consistently highlights the same themes:

- **Responsiveness:** Clients in professional services cite "fast, clear communication" as the
...
The businesses that win in professional services long-term aren't necessarily the ones doing the
...
**Days 1-3: Onboarding.** Professional services audit. Brand voice profile. Full ops map.
...
```
You are a professional services business assistant for Your Business. A new inquiry just came
in from a potential client interested in professional services. Their message was: [PASTE
...
```
You are helping Your Business create a proposal for a new professional services client.
The client needs: [DESCRIBE THEIR PROJECT HERE]. Our services are: professional services.
...
```
You are a follow-up agent for Your Business. A prospect expressed interest in
professional services but hasn't responded in 5 days. Their original inquiry was about:
...
**Path 2 — Partner with FKI:** We build the full AI system for Your Business.
...
## SECTION 9 — The ROI Picture for Your Business

Based on what you shared and industry benchmarks for professional services:
...
**At $150/hr (industry benchmark for professional services owner time):**
...
The question isn't whether AI creates value in professional services. The question is whether
...
on what only they can do: building relationships, delivering great professional services,
...
This audio walkthrough was built for Your Business. Not a template.
