...
AI Roadmap for Paul Muus — Paul Muus Consulting
...
You are creating an audio walkthrough for one specific person: Paul Muus.

ADDRESS ALL REMARKS DIRECTLY TO PAUL MUUS. Use "you" and "your business" and
"your team" throughout. NEVER say "this business," "Paul Muus Consulting's company," or refer
to Paul Muus in the third person. You are speaking TO Paul Muus, not ABOUT them.

YOUR OPENING LINE MUST BE: "This audio walkthrough was built specifically for you,
Paul Muus. Every number, every recommendation, and every example in what you're
...
## SECTION 1 — About You and Paul Muus Consulting

Paul Muus, you've built Paul Muus Consulting into something worth talking about.
You operate in renewable energy consulting, serving project developers, procurement managers, and C-suite at renewable energy companies. Your website is https://paulmuus.com.

Your business delivers Renewable Energy Consulting, Project Development, Proposal Creation, Stakeholder Engagement. You're working in a market where speed,
...
Your team is the backbone of Paul Muus Consulting.

You told us your current AI use is early-stage. That's exactly where most renewable energy consulting businesses are right now — and it's the right starting point.

The 3 AI tools described in Section 4 were written specifically for Paul Muus Consulting.
Not adjusted from a template. Built from what you told us, for how your business actually works.

---

## SECTION 2 — Your Current Tool Stack: Where Paul Muus Consulting Is Today
...
These aren't guesses. These are the gaps that show up consistently for renewable energy consulting
...
In renewable energy consulting, that window is measured in minutes — sometimes seconds. Every hour your
...
In renewable energy consulting, this shows up as: proposal writing, status updates, follow-up emails,
...
## SECTION 4 — The 3 AI Tools Built Specifically for Paul Muus Consulting
...
You are a speed-to-lead response agent for a renewable energy consulting practice. When a new inquiry comes in from an energy partner or project developer, respond within 60 seconds with a warm, professional message that acknowledges their project type and offers a discovery call.
...
You are a proposal draft agent for a renewable energy consulting firm. Given project details, stakeholder requirements, and budget range, generate a professional consulting proposal with scope of work, timeline, and projected impact.

Built around how Paul Muus Consulting actually works — not a generic industry template.

---

### AI Tool 3 — Follow-Up and Outreach Agent

You are an organic lead discovery agent for a renewable energy consulting practice. Identify project developers, procurement managers, and executives at renewable energy companies on LinkedIn and generate personalized outreach messages in Paul's elevated, warm, never salesy tone.
...
## SECTION 5 — What Your Customers Already Say About Paul Muus Consulting

Your reputation in project developers, procurement managers, and C-suite at renewable energy companies is an asset. Customer feedback for renewable energy consulting businesses
at your stage consistently highlights the same themes:

- **Responsiveness:** Clients in renewable energy consulting cite "fast, clear communication" as the
...
The businesses that win in renewable energy consulting long-term aren't necessarily the ones doing the
...
**Days 1-3: Onboarding.** Renewable energy consulting audit. Brand voice profile. Full ops map.
...
```
You are a renewable energy consulting business assistant for Paul Muus Consulting. A new inquiry just came
in from a potential client interested in Renewable Energy Consulting, Project Development, Proposal Creation, Stakeholder Engagement. Their message was: [PASTE
...
```
You are helping Paul Muus Consulting create a proposal for a new renewable energy consulting client.
The client needs: [DESCRIBE THEIR PROJECT HERE]. Our services are: Renewable Energy Consulting, Project Development, Proposal Creation, Stakeholder Engagement.
...
```
You are a follow-up agent for Paul Muus Consulting. A prospect expressed interest in
Renewable Energy Consulting, Project Development, Proposal Creation, Stakeholder Engagement but hasn't responded in 5 days. Their original inquiry was about:
...
**Path 2 — Partner with FKI:** We build the full AI system for Paul Muus Consulting.
...
## SECTION 9 — The ROI Picture for Paul Muus Consulting

Based on what you shared and industry benchmarks for renewable energy consulting:
...
**At $150/hr (industry benchmark for renewable energy consulting owner time):**
...
The question isn't whether AI creates value in renewable energy consulting. The question is whether
...
on what only they can do: building relationships, delivering great Renewable Energy Consulting, Project Development, Proposal Creation, Stakeholder Engagement,
...
This audio walkthrough was built for Paul Muus Consulting. Not a template.
