<!-- v1.6 -->
PRIVATE AUDIO BRIEFING — Personal AI Walkthrough for Barbara
Upper Crust Designs LLC | Prepared by Franchise Ki | Generated 2026-07-17

================================================================================
SPEAKER INSTRUCTIONS — 3 HARD RULES (read this once, then begin)
================================================================================

RULE 1 (RED LINE): You are speaking DIRECTLY to BARBARA. Use "you" and
"your business" in every paragraph. NEVER say "Barbara" in the third person.
NEVER say "this business," "the owner," "they," or "their team." If you catch
yourself describing Barbara from the outside, stop and restart the sentence
addressed to them.

RULE 2: Open the audio with EXACTLY these words: "Hi Barbara, welcome.
This walkthrough was built for you and Upper Crust Designs LLC, from what you told us."
Then proceed.
...
## SECTION 1 — Hi Barbara, this is your walkthrough

Hi Barbara — welcome. This is your AI walkthrough, built for you and
Upper Crust Designs LLC. Every number you're about to hear came from what you told us.

You operate in custom design services, serving customers ordering custom, made-to-order design pieces for specific occasions. You run Upper Crust Designs LLC at [Upper Crust Designs LLC website].
...
You told us your current tools are: your current inquiry inbox, website form, and CRM. We're going to wire your AI system
...
You told us your current AI use is early-stage. That's exactly where most custom design services businesses are right now — and it's the right starting point.

The 3 AI tools you'll hear about in Section 4 were written specifically for you and
Upper Crust Designs LLC. Not adjusted from a template. Built from your answers, for how
your business actually works. Let's walk through what's possible.

---

## SECTION 2 — Your Current Tool Stack: Where Upper Crust Designs LLC Is Today

WHERE YOU ARE TODAY — your current operational infrastructure:

- **your current inquiry inbox**: Core operational tool in your current stack.
- **website form**: Core operational tool in your current stack.
- **and CRM**: Core operational tool in your current stack.
...
These aren't guesses. These are the gaps that show up consistently for custom design services
...
In custom design services, that window is measured in minutes — sometimes seconds. Every hour your
...
In custom design services, this shows up as: proposal writing, status updates, follow-up emails,
...
## SECTION 4 — The 3 AI Tools Built Specifically for Upper Crust Designs LLC
...
[No custom prompt provided — describe key AI speed-to-lead opportunity for custom design services]
...
[No custom prompt provided — describe key AI proposal or qualification opportunity for custom design services]

Built around how Upper Crust Designs LLC actually works — not a generic industry template.

---

### AI Tool 3 — Follow-Up and Outreach Agent

[No custom prompt provided — describe key AI follow-up or outreach opportunity for custom design services]
...
## SECTION 5 — What Your Customers Already Say About Upper Crust Designs LLC

Your reputation in customers ordering custom, made-to-order design pieces for specific occasions is an asset. Customer feedback for custom design services businesses
at your stage consistently highlights the same themes:

- **Responsiveness:** Clients in custom design services cite "fast, clear communication" as the
...
The businesses that win in custom design services long-term aren't necessarily the ones doing the
...
**Week 1: Onboarding.** Custom design services audit. Brand voice profile. Full ops map.
...
```
You are a custom design services business assistant for Upper Crust Designs LLC. A new inquiry just came
in from a potential client interested in Custom made-to-order design, Custom orders for special occasions, Personalized design pieces. Their message was: [PASTE
...
```
You are helping Upper Crust Designs LLC create a proposal for a new custom design services client.
The client needs: [DESCRIBE THEIR PROJECT HERE]. Our services are: Custom made-to-order design, Custom orders for special occasions, Personalized design pieces.
...
```
You are a follow-up agent for Upper Crust Designs LLC. A prospect expressed interest in
Custom made-to-order design, Custom orders for special occasions, Personalized design pieces but hasn't responded in 5 days. Their original inquiry was about:
...
**Path 2 — Partner with FKI:** We build the full AI system for Upper Crust Designs LLC.
The 3 tools in Section 4. The 30-day onboarding timeline. The ongoing calibration.
Everything automated, integrated with your current inquiry inbox, website form, and CRM, running without your team having to
manage it.
...
## SECTION 9 — The ROI Picture for Upper Crust Designs LLC

Based on what you shared and industry benchmarks for custom design services:
...
**At $150/hr (industry benchmark for custom design services owner time):**
...
The question isn't whether AI creates value in custom design services. The question is whether
...
on what only they can do: building relationships, delivering great Custom made-to-order design, Custom orders for special occasions, Personalized design pieces,
...
integrated with your current inquiry inbox, website form, and CRM, triggered by your actual business events — a new inquiry,
