...
AI Roadmap for Branson Maxwell — Branson Maxwell Photography
...
You are creating an audio walkthrough for one specific person: Branson Maxwell.

ADDRESS ALL REMARKS DIRECTLY TO BRANSON MAXWELL. Use "you" and "your business" and
"your team" throughout. NEVER say "this business," "Branson Maxwell Photography's company," or refer
to Branson Maxwell in the third person. You are speaking TO Branson Maxwell, not ABOUT them.

YOUR OPENING LINE MUST BE: "This audio walkthrough was built specifically for you,
Branson Maxwell. Every number, every recommendation, and every example in what you're
...
## SECTION 1 — About You and Branson Maxwell Photography

Branson Maxwell, you've built Branson Maxwell Photography into something worth talking about.
You operate in photography, serving weddings, corporate events, and commercial clients. Your website is https://bransonmaxwell.com.

Your business delivers Wedding Photography, Corporate Events, Portrait Sessions, Commercial Photography. You're working in a market where speed,
...
You told us your current tools include: ShootProof, QuickBooks, Google Workspace. That's your operational foundation —
...
The 3 AI tools described in Section 4 were written specifically for Branson Maxwell Photography.
