<!-- v1.6 -->
PRIVATE AUDIO BRIEFING — Personal AI Walkthrough for Martha
Martha | Prepared by Franchise Ki | Generated 2026-07-01

================================================================================
SPEAKER INSTRUCTIONS — 3 HARD RULES (read this once, then begin)
================================================================================

RULE 1 (RED LINE): You are speaking DIRECTLY to MARTHA. Use "you" and
"your business" in every paragraph. NEVER say "Martha" in the third person.
NEVER say "this business," "the owner," "they," or "their team." If you catch
yourself describing Martha from the outside, stop and restart the sentence
addressed to them.

RULE 2: Open the audio with EXACTLY these words: "Hi Martha, welcome.
This walkthrough was built for you and Martha, from what you told us."
Then proceed.
...
## SECTION 1 — Hi Martha, this is your walkthrough

Hi Martha — welcome. This is your AI walkthrough, built for you and
Martha. Every number you're about to hear came from what you told us.

You operate in paid expert-matching marketplace for franchising, serving franchise candidates, prospective and current franchisees, and operators who want vetted advice from proven founders and franchise leaders. You run Martha at https://www.joinmartha.com.
...
You told us your current tools are: GHL, Stripe, Calendly, Zoom. We're going to wire your AI system
directly into what you're already running. Nothing you use today gets ripped out.
Everything gets amplified.

Your team is the backbone of Martha.

You told us your current AI use is early-stage. That's exactly where most paid expert-matching marketplace for franchising businesses are right now — and it's the right starting point.

The 3 AI tools you'll hear about in Section 4 were written specifically for you and
Martha. Not adjusted from a template. Built from your answers, for how
your business actually works. Let's walk through what's possible.

---

## SECTION 2 — Your Current Tool Stack: Where Martha Is Today

WHERE YOU ARE TODAY — your current operational infrastructure:

- **GHL**: Core operational tool in your current stack.
- **Stripe**: Core operational tool in your current stack.
...
These aren't guesses. These are the gaps that show up consistently for paid expert-matching marketplace for franchising
...
In paid expert-matching marketplace for franchising, that window is measured in minutes — sometimes seconds. Every hour your
...
In paid expert-matching marketplace for franchising, this shows up as: proposal writing, status updates, follow-up emails,
...
## SECTION 4 — The 3 AI Tools Built Specifically for Martha
...
You are a speed-to-lead response agent for a paid expert-matching marketplace for franchising business called Martha. When a new inquiry comes in, draft a personalized response within 60 seconds that acknowledges their specific request, highlights relevant services, and suggests a next step.
...
You are a proposal draft agent for Martha in the paid expert-matching marketplace for franchising industry. Given a prospect's requirements, generate a professional proposal including scope, timeline, pricing framework, and 3 reasons to choose Martha over competitors.

Built around how Martha actually works — not a generic industry template.

---

### AI Tool 3 — Follow-Up and Outreach Agent

You are an outreach agent for Martha (paid expert-matching marketplace for franchising). Generate 5 personalized LinkedIn connection messages and 5 cold email templates targeting ideal customers who need paid expert-matching marketplace for franchising services.
...
## SECTION 5 — What Your Customers Already Say About Martha

Your reputation in franchise candidates, prospective and current franchisees, and operators who want vetted advice from proven founders and franchise leaders is an asset. Customer feedback for paid expert-matching marketplace for franchising businesses
at your stage consistently highlights the same themes:

- **Responsiveness:** Clients in paid expert-matching marketplace for franchising cite "fast, clear communication" as the
...
The businesses that win in paid expert-matching marketplace for franchising long-term aren't necessarily the ones doing the
...
**Days 1-3: Onboarding.** Paid expert-matching marketplace for franchising audit. Brand voice profile. Full ops map.
...
```
You are a paid expert-matching marketplace for franchising business assistant for Martha. A new inquiry just came
in from a potential client interested in On-Demand Expert Franchise Advice, Vetted Founder & Operator Matching, Pay-Only-When-Delivered Answers, 7-Day Request Window Guarantee, Verification Badges (Founder / Qualified Leader / Rising Founder), Knowledge Base & Expert Profiles. Their message was: [PASTE
...
```
You are helping Martha create a proposal for a new paid expert-matching marketplace for franchising client.
The client needs: [DESCRIBE THEIR PROJECT HERE]. Our services are: On-Demand Expert Franchise Advice, Vetted Founder & Operator Matching, Pay-Only-When-Delivered Answers, 7-Day Request Window Guarantee, Verification Badges (Founder / Qualified Leader / Rising Founder), Knowledge Base & Expert Profiles.
...
```
You are a follow-up agent for Martha. A prospect expressed interest in
On-Demand Expert Franchise Advice, Vetted Founder & Operator Matching, Pay-Only-When-Delivered Answers, 7-Day Request Window Guarantee, Verification Badges (Founder / Qualified Leader / Rising Founder), Knowledge Base & Expert Profiles but hasn't responded in 5 days. Their original inquiry was about:
...
**Path 2 — Partner with FKI:** We build the full AI system for Martha.
The 3 tools in Section 4. The 30-day onboarding timeline. The ongoing calibration.
Everything automated, integrated with GHL, Stripe, Calendly, Zoom, running without your team having to
manage it.
...
## SECTION 9 — The ROI Picture for Martha

Based on what you shared and industry benchmarks for paid expert-matching marketplace for franchising:
...
**At $150/hr (industry benchmark for paid expert-matching marketplace for franchising owner time):**
...
The question isn't whether AI creates value in paid expert-matching marketplace for franchising. The question is whether
...
on what only they can do: building relationships, delivering great On-Demand Expert Franchise Advice, Vetted Founder & Operator Matching, Pay-Only-When-Delivered Answers, 7-Day Request Window Guarantee, Verification Badges (Founder / Qualified Leader / Rising Founder), Knowledge Base & Expert Profiles,
...
integrated with GHL, Stripe, Calendly, Zoom, triggered by your actual business events — a new inquiry,
...
This audio walkthrough was built for Martha. Not a template.
