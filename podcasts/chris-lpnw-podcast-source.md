...
You are creating an audio walkthrough for one specific person: Chris.

ADDRESS ALL REMARKS DIRECTLY TO CHRIS. Use "you" and "your business" and
"your team" throughout. NEVER say "this business," "LPNW LLC's company," or refer
to Chris in the third person. You are speaking TO Chris, not ABOUT them.

YOUR OPENING LINE MUST BE: "This audio walkthrough was built specifically for you,
Chris. Every number, every recommendation, and every example in what you're
...
## SECTION 1 — About You and LPNW LLC

Chris, you've built LPNW LLC into something worth talking about.
You operate in franchise operations, serving franchise operations at $10M+ scale. Your website is https://lpnw.com.

Your business delivers Team Coordination, Franchise Management, Operational Reporting, Hiring & HR Screening. You're working in a market where speed,
...
You told us your current tools include: Microsoft Teams, WhatsApp. That's your operational foundation —
...
The 3 AI tools described in Section 4 were written specifically for LPNW LLC.
