<!-- v1.6 -->
Personal AI Walkthrough for Personal AI Walkthrough for Dave Wood
...
RULE 1 (RED LINE): You are speaking DIRECTLY to DAVE WOOD. Use "you" and
"your business" in every paragraph. NEVER say "Dave Wood" in the third person.
NEVER say "this business," "the owner," "they," or "their team." If you catch
yourself describing Dave Wood from the outside, stop and restart the sentence
addressed to them.

RULE 2: Open the audio with EXACTLY these words: "Hi Dave, welcome.
...
## SECTION 1 — Hi Dave, this is your walkthrough

Hi Dave — welcome. This is your AI walkthrough, built for you and
Mahana Fresh. Every number you're about to hear came from what you told us.

You operate in fast-casual restaurant franchise, serving fast-casual healthy dining franchise. You run Mahana Fresh at https://www.mahanafresh.com.
...
You told us your current tools are: Not specified in form (LinkedIn DM lead). We're going to wire your AI system
directly into what you're already running. Nothing you use today gets ripped out.
Everything gets amplified.

Your team of 100+ years combined restaurant experience across leadership handles the day-to-day execution.

You told us your current AI use is early-stage. That's exactly where most fast-casual restaurant franchise businesses are right now — and it's the right starting point.

The 3 AI tools you'll hear about in Section 4 were written specifically for you and
Mahana Fresh. Not adjusted from a template. Built from your answers, for how
your business actually works. Let's walk through what's possible.

---

## SECTION 2 — Your Current Tool Stack: Where Mahana Fresh Is Today

WHERE YOU ARE TODAY — your current operational infrastructure:

- **Not specified in form (LinkedIn DM lead)**: Core operational tool in your current stack.
- **Standard fast-casual restaurant franchise workflow tools**: Core operational tool in your current stack.
...
These aren't guesses. These are the gaps that show up consistently for fast-casual restaurant franchise
...
In fast-casual restaurant franchise, that window is measured in minutes — sometimes seconds. Every hour your
...
Ref: HBR, "The Short Life of Online Sales Leads" (2011) — https://hbr.org/2011/03/the-short-life-of-online-sales
...
Ref: McKinsey, "The B2B digital inflection point" (2020) — https://www.mckinsey.com/capabilities/growth-marketing-and-sales
...
In fast-casual restaurant franchise, this shows up as: proposal writing, status updates, follow-up emails,
...
Ref: SBA, Small Business Time Study — https://www.sba.gov/business-guide

---

## SECTION 4 — The 3 AI Tools Built Specifically for Mahana Fresh
...
You are a speed-to-lead response agent for a fast-casual restaurant franchise business called Mahana Fresh. When a new inquiry comes in, draft a personalized response within 60 seconds that acknowledges their specific request, highlights relevant services, and suggests a next step.
...
You are a proposal draft agent for Mahana Fresh in the fast-casual restaurant franchise industry. Given a prospect's requirements, generate a professional proposal including scope, timeline, pricing framework, and 3 reasons to choose Mahana Fresh over competitors.

Built around how Mahana Fresh actually works — not a generic industry template.

---

### AI Tool 3 — Follow-Up and Outreach Agent

You are an outreach agent for Mahana Fresh (fast-casual restaurant franchise). Generate 5 personalized LinkedIn connection messages and 5 cold email templates targeting ideal customers who need fast-casual restaurant franchise services.
...
## SECTION 5 — What Your Customers Already Say About Mahana Fresh

Your reputation in fast-casual healthy dining franchise is an asset. Customer feedback for fast-casual restaurant franchise businesses
at your stage consistently highlights the same themes:

- **Responsiveness:** Clients in fast-casual restaurant franchise cite "fast, clear communication" as the
...
The businesses that win in fast-casual restaurant franchise long-term aren't necessarily the ones doing the
...
Here's exactly what the next phase look like if you move forward:
...
```
You are a fast-casual restaurant franchise business assistant for Mahana Fresh. A new inquiry just came
in from a potential client interested in Customizable Bowls, Wraps, Catering Services, Franchise Development, E-Gift Cards, Online Ordering. Their message was: [PASTE
...
```
You are helping Mahana Fresh create a proposal for a new fast-casual restaurant franchise client.
The client needs: [DESCRIBE THEIR PROJECT HERE]. Our services are: Customizable Bowls, Wraps, Catering Services, Franchise Development, E-Gift Cards, Online Ordering.
...
```
You are a follow-up agent for Mahana Fresh. A prospect expressed interest in
Customizable Bowls, Wraps, Catering Services, Franchise Development, E-Gift Cards, Online Ordering but hasn't responded in 5 days. Their original inquiry was about:
...
**Path 2 — Partner with FKI:** We build the full AI system for Mahana Fresh.
The 3 tools in Section 4. The 30-day onboarding timeline. The ongoing calibration.
Everything automated, integrated with Not specified in form (LinkedIn DM lead), running without your team having to
manage it.
...
Qualify here: https://blueprint.meetadvaita.com/qualify.html

This is an application, not a commitment. We read every one personally.

---

## SECTION 9 — The ROI Picture for Mahana Fresh

Based on what you shared and industry benchmarks for fast-casual restaurant franchise:
...
**At $150/hr (industry benchmark for fast-casual restaurant franchise owner time):**
...
The question isn't whether AI creates value in fast-casual restaurant franchise. The question is whether
...
on what only they can do: building relationships, delivering great Customizable Bowls, Wraps, Catering Services, Franchise Development, E-Gift Cards, Online Ordering,
...
integrated with Not specified in form (LinkedIn DM lead), triggered by your actual business events — a new inquiry,
...
https://blueprint.meetadvaita.com/qualify.html
