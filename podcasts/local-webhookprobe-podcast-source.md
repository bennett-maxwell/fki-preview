...
RULE 1 (RED LINE): You are speaking DIRECTLY to LOCAL WEBHOOKPROBE. Use "you" and
"your business" in every paragraph. NEVER say "Local WebhookProbe" in the third person.
NEVER say "this business," "the owner," "they," or "their team." If you catch
yourself describing Local WebhookProbe from the outside, stop and restart the sentence
addressed to them.

RULE 2: Open the audio with EXACTLY these words: "Hi Local, welcome.
This walkthrough was built for you and Local WebhookProbe, from what you told us."
Then proceed.
...
## SECTION 1 — Hi Local, this is your walkthrough

Hi Local — welcome. This is your AI walkthrough, built for you and
Local WebhookProbe. Every number you're about to hear came from what you told us.

You operate in business services, serving local and regional customers. You run Local WebhookProbe at https://franchiseki.com.
...
You told us your current tools are: . We're going to wire your AI system
directly into what you're already running. Nothing you use today gets ripped out.
Everything gets amplified.

Your team is the backbone of Local WebhookProbe.

You told us your current AI use is early-stage. That's exactly where most business services businesses are right now — and it's the right starting point.

The 3 AI tools you'll hear about in Section 4 were written specifically for you and
Local WebhookProbe. Not adjusted from a template. Built from your answers, for how
your business actually works. Let's walk through what's possible.

---

## SECTION 2 — Your Current Tool Stack: Where Local WebhookProbe Is Today

WHERE YOU ARE TODAY — your current operational infrastructure:

- **Standard business services workflow tools**: Core operational tool in your current stack.
...
These aren't guesses. These are the gaps that show up consistently for business services
...
In business services, that window is measured in minutes — sometimes seconds. Every hour your
...
In business services, this shows up as: proposal writing, status updates, follow-up emails,
...
## SECTION 4 — The 3 AI Tools Built Specifically for Local WebhookProbe
...
## SECTION 5 — What Your Customers Already Say About Local WebhookProbe

Your reputation in local and regional customers is an asset. Customer feedback for business services businesses
at your stage consistently highlights the same themes:

- **Responsiveness:** Clients in business services cite "fast, clear communication" as the
...
The businesses that win in business services long-term aren't necessarily the ones doing the
...
```
You are a business services business assistant for Local WebhookProbe. A new inquiry just came
...
```
You are helping Local WebhookProbe create a proposal for a new business services client.
...
```
You are a follow-up agent for Local WebhookProbe. A prospect expressed interest in
...
**Path 2 — Partner with FKI:** We build the full AI system for Local WebhookProbe.
The 3 tools in Section 4. The 30-day onboarding timeline. The ongoing calibration.
Everything automated, integrated with , running without your team having to
manage it.
...
## SECTION 9 — The ROI Picture for Local WebhookProbe

Based on what you shared and industry benchmarks for business services:
...
**At $150/hr (industry benchmark for business services owner time):**
...
The question isn't whether AI creates value in business services. The question is whether
...
integrated with , triggered by your actual business events — a new inquiry,
...
This audio walkthrough was built for Local WebhookProbe. Not a template.
