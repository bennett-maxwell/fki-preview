...
- memory proof: memory-skill receipt, Codex ad_hoc memory note path, or canonical Drive memory file ID plus readback; OR
- `memory partial:<exact blocker>` and a reconciliation receipt path.
